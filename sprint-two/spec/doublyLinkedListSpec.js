describe('doublyLinkedList', function () {
  ...
  // New tests for doubly linked lists
  it('should take a value and add to head of list', function () {
  ...
  it('should return the value of the former tail when removeTail is called', function () {
    ...
    expect(doublyLinkedList.removeTail()).to.equal(10);
  });

  it('should remove tail and set tail.previous to tail', function () {
    doublyLinkedList.addToHead(10);
  ...
  // Old tests for singly linked lists
